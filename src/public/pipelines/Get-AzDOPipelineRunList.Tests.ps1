Describe 'Integration Tests' -Tag 'Integration' {
    ...
    It 'should return builds in order of id' {
        $builds = Get-AzDOPipeline -Name PipelineTest -Project Tools |
    ...
    It 'should exclude PR builds if specified' {
        $fiftyBuilds = Get-AzDOPipeline -Name AzDOCmd -Project Tools |
    ...
    It 'should still get a build if MaxBuilds is 1 and most recent is a PR' {
        $nonPrBuild = Get-AzDOPipeline -Name AzDOCmd -Project Tools |
    ...
    It 'should only get in progress builds if specified' {
        Get-AzDOPipeline -Name AzDOCmd -Project Tools |
